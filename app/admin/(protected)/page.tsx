...
const sections = [
  { label: "Shows", description: "Add, edit or remove upcoming shows", href: "/admin/shows", icon: CalendarDays },
  { label: "Gallery", description: "Manage photo gallery images", href: "/admin/gallery", icon: Images },
  { label: "Biography", description: "Update biography content", href: "/admin/biography", icon: BookOpen },
  { label: "Booking", description: "Edit booking contact & details", href: "/admin/booking", icon: Phone },
  { label: "Videos", description: "Manage featured and recommended videos", href: "/admin/videos", icon: Video },
];
