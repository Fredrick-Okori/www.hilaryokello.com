...
const VideoSection = dynamic(
  () =>
    import("@/components/videos").then((mod) => ({
...
const UpcomingShows = dynamic(
  () => import("@/components/upcoming.show").then((mod) => mod.default),
  {
    loading: () => <div className="h-64 bg-black-light animate-pulse" />,
  },
);
...
export const metadata: Metadata = {
  title:
    "Home | Dr. Hilary Okello | Uganda's Funniest Stand-Up Comedian & Africa's Doctor of Comedy",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "Discover hilarious stand-up clips, upcoming shows, and exclusive content from Africa's Doctor of Comedy.",
    type: "website",
    images: [
      {
...
export default function Page() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <Suspense
        fallback={<div className="h-64 bg-black-light animate-pulse" />}
      >
        <UpcomingShows />
      </Suspense>
